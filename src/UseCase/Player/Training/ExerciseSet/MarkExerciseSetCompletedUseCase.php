...
final class MarkExerciseSetCompletedUseCase extends AbstractLoggedPlayerUseCase
{
    public function __construct(
        private readonly MarkExerciseSetCompletedValidator $markExerciseSetCompletedValidator,
    ...
    /**
     * @param MarkExerciseSetCompletedDataInput $input
     */
    public function execute(DataInputInterface $input): ExerciseSetDataOutput
    {
        ...
        $this->markExerciseSetCompletedValidator->validate($player, $input, $set);
